...
class Filter extends BaseRc {
		...
		return (
			<div>
				<Flex justify="center" className='shared-dropMenu'>
					...
					<Flex.Item>
			      		<div className='shared-dropMenu-item' 
			      			onClick={ this.pushRouter.bind(this, '/quantify/myRelated/screen') }>
			      			高级筛选
			      		</div>
			      	</Flex.Item>
			    </Flex>
	...
	renderTimeMenu() {
		...
		return [(
			...
			<div className="shared-menu-mask" onClick={ this.onMaskClick.bind(this) } style={{'top':'89px'}}/>
		)]
	}
...
const mapStateToProps = state => {
	const mStore = state.m_quantify.m_myRelated.m_index
	return {
